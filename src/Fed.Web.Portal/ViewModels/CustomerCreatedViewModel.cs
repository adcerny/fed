...
{
    public class AccountsCreatedViewModel
    {
        private Customer _customer;
        private Date? _nextDeliveryDate;


        public AccountsCreatedViewModel(Customer customer, Date? nextDeliveryDate)
        {
            _customer = customer;
            _nextDeliveryDate = nextDeliveryDate;
        }

        public string CustomerId { get { return _customer.Id.ToString(); } }
        ...
        public string Agent { get { return _customer.CustomerAgentId.ToString(); } }

        public string MarketingAttribute { get { return _customer.CustomerMarketingAttributeId.ToString(); } }
    }
}
